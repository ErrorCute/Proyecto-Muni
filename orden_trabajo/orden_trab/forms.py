...
class EmpleadoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fecha_termino_contrata': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}, format='%Y-%m-%d'),
            'anios_servicio': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'situacion_discapacidad': forms.Select(choices=Empleado.DISCAPACIDAD_CHOICES, attrs={'class': 'form-control'}),  # Cambio aquí
            'etnia': forms.Select(choices=Empleado.ETNIA_CHOICES, attrs={'class': 'form-control'}),  # Correcto, ya como Select
        }
